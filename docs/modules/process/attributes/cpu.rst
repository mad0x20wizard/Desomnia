...
Use the ``watch`` expression to combine this result with other configured metrics. With no
thresholds, the default catch-all expression counts every matching process as activity.
